...
示例
    python run_carryforward_experiment.py --output-dir output_carryforward --max-tickers 3
    python run_carryforward_experiment.py --smoke-synthetic-only   # 仅内存合成，验证逻辑
    python run_carryforward_experiment.py --smoke                  # 合成自检 + 最小真实数据跑通
"""
